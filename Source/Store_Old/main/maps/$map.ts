...
import { ShowChangesSinceType, MapInfo } from 'Store_Old/main/maps/@MapInfo';
...
import { ReversePolarity } from 'Store_Old/firebase/nodes/$node';
...
export const GetTimeSinceNodeRevealedByPlayingTimeline = StoreAccessor((mapID: string, nodePath: string, timeSinceLastReveal = false, limitToJustPastHighlightRange = false): number => {
	...
	const timelineTime = store.main.maps.get(mapID).playingTimeline_time;

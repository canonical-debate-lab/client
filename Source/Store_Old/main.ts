...
import { MapInfoReducer } from './main/maps/$map';
import { MapInfo } from './main/maps/@MapInfo';
import { Personal, ACTPersonalMapSelect, PersonalReducer } from './main/personal';
...
export const GetOpenMapID = StoreAccessor(() => {
	...
	if (page == 'personal') return store.main.personal.selectedMapID;
	if (page == 'debates') return store.main.debates.selectedMapID;
